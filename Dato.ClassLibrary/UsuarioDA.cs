...
namespace Dato.ClassLibrary
{
    public class UsuarioDA
    {
        ...
        static UsuarioDA()
        {
            ...
            {
                new UsuarioBE {Id=0, User = "cliente@cs2.com", Password = "cliente123", FirtsName="NombreCliente" , LastsName="ApellidoCliente", NumberPhone="987564234",Address = "Jr. Example #456", Reference= "Casa blanca de 2 pisos", Session = 0 },
